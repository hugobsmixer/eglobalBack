...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.demo.DemoApplicationTests", () -> new AotSpringBootConfigContextLoader(DemoApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.demo.DemoApplicationTests", DemoApplicationTestsContextInitializer.class);
    return entries;
  }
}
